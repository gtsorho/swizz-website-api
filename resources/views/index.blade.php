...
<body>
  ...
  <main id="main">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="box">
              ...
              <img src="assets/img/portfolio/portfolio-4.jpg" class="img-fluid" alt="">
              <div class="btn-wrap">
                <a href="#" class="btn-buy"  onClick="makePayment()" >Buy Now</a>
              </div>
            </div>
          </div>
    ...
    <section id="contact" class="contact">
      ...
      <div>
        <iframe style="border:0; width: 100%; height: 350px;" src="php " frameborder="0" allowfullscreen></iframe>
      </div>
  ...
  <script>
    function makePayment() {
      FlutterwaveCheckout({
        public_key: "FLWPUBK_TEST-efc89d25a30ac3f2405556eaa014d464-X",
